...
object DbSetup {
  ...
  def setup(): Unit = {
    ...
    val setup = DBIO.seq(
      ...
      StarSystemTable.starSystem ++= Seq(
        StarSystem(STARSYSTEMID_SOLAR, "SolarSystem"),
        StarSystem(STARSYSTEMID_SIRIUS, "Syrius"),
        StarSystem(STARSYSTEMID_ALFACENTAVRA, "AlfaCentavra"),
      ),
